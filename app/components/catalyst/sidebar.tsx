...
export function SidebarDivider({ className, ...props }: React.ComponentPropsWithoutRef<"hr">) {
  return <hr {...props} className={clsx(className, "border-border my-4 border-t lg:-mx-4")} />;
}
...
export function SidebarHeading({ className, ...props }: React.ComponentPropsWithoutRef<"h3">) {
  return (
    <h3
      {...props}
      className={clsx(className, "text-muted-foreground mb-1 px-2 text-xs/6 font-medium")}
    />
  );
}
